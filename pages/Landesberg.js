    ...
    return(
        <div>
         ...
         <iframe width = "100%" height="600px" src="https://player.vimeo.com/video/822699151?h=a774012d6f&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479"
            ...
            <div className = {styles.cont}> 
            <p className = {styles.text}>
            Kiosk experience of Weingart&rsquo;s work and life as a compliment to the booklet. Explored interactions on a large screen. 
            </p>
            <br/>
         </div>
         </div>
         ...
         <h1 className = {styles.mTitle}> 
            ...
            <div className = {styles.cont}> 
            <p className = {styles.text}>
            An interactive website that consists of a timeline of Weingart&rsquo;s accomplishments, 
            a brief biography, and a gallery of his most famous pieces, 
            highlighting his career and visual style. Utilized variable fonts and the Jquery.js library to play with typography. 
            </p>
            <br/>
